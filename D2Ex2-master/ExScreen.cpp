...
void ExScreen::DrawResInfo() {
	...
	int fres = nRes, lres = nRes, cres = nRes, pres = nRes;

	signed int h = (signed int)*D2Vars.D2CLIENT_ScreenHeight;

	fres += D2Funcs.D2COMMON_GetStatSigned(ptUnit, STAT_FIRERESIST, 0);
	lres += D2Funcs.D2COMMON_GetStatSigned(ptUnit, STAT_LIGHTRESIST, 0);
	cres += D2Funcs.D2COMMON_GetStatSigned(ptUnit, STAT_COLDRESIST, 0);
	pres += D2Funcs.D2COMMON_GetStatSigned(ptUnit, STAT_POISONRESIST, 0);

	wostringstream wInfo;
	wInfo << /*(gLocaleId == LOCALE_POL ? L"Ca³kowita odpornoœæ: " : L"Stacked resistance: ") 
		<< */GetColorCode(COL_RED) << fres << "  " 
		<< GetColorCode(COL_YELLOW) << lres << "  " 
		<< GetColorCode(COL_BLUE) << cres << "  " 
		<< GetColorCode(COL_LIGHTGREEN) << pres;
	D2Funcs.D2WIN_SetTextSize(0);
	D2Funcs.D2WIN_DrawRectangledText(wInfo.str().c_str(), 200 + *D2Vars.D2CLIENT_UIPanelDrawXOffset, h + *D2Vars.D2CLIENT_UIPanelDrawYOffset - 150, 0, 2, COL_WHITE);
	...
	//}
	//else if (mX>175 + *D2Vars.D2CLIENT_UIPanelDrawXOffset && mX< 316 + *D2Vars.D2CLIENT_UIPanelDrawXOffset && mY>h + *D2Vars.D2CLIENT_UIPanelDrawYOffset - 123 && mY< h + *D2Vars.D2CLIENT_UIPanelDrawYOffset - 98)  //Cold Res
	//{
	...
	//	D2Funcs.D2WIN_DrawRectangledText(wInfo.str().c_str(), 160 + *D2Vars.D2CLIENT_UIPanelDrawXOffset, h + *D2Vars.D2CLIENT_UIPanelDrawYOffset - 150, 0, 2, COL_WHITE);
	//}
	//else if (mX>175 + *D2Vars.D2CLIENT_UIPanelDrawXOffset && mX< 316 + *D2Vars.D2CLIENT_UIPanelDrawXOffset && mY>h + *D2Vars.D2CLIENT_UIPanelDrawYOffset - 99 && mY< h + *D2Vars.D2CLIENT_UIPanelDrawYOffset - 74)  //Light Res
	//{
	...
	//	D2Funcs.D2WIN_DrawRectangledText(wInfo.str().c_str(), 160 + *D2Vars.D2CLIENT_UIPanelDrawXOffset, h + *D2Vars.D2CLIENT_UIPanelDrawYOffset - 150, 0, 2, COL_WHITE);
	//}
	//else if (mX>175 + *D2Vars.D2CLIENT_UIPanelDrawXOffset && mX< 316 + *D2Vars.D2CLIENT_UIPanelDrawXOffset && mY>h + *D2Vars.D2CLIENT_UIPanelDrawYOffset - 75 && mY< h + *D2Vars.D2CLIENT_UIPanelDrawYOffset - 50)  //Poison Res
	//{
...
void ExScreen::DrawBreakpoints() {
	...
	ExScreen::DrawTextEx(36 + *D2Vars.D2CLIENT_UIPanelDrawXOffset, *D2Vars.D2CLIENT_ScreenHeight + *D2Vars.D2CLIENT_UIPanelDrawYOffset - 156, COL_WHITE, 0, 5, L"REP");
	ExScreen::DrawTextEx(37 + *D2Vars.D2CLIENT_UIPanelDrawXOffset, *D2Vars.D2CLIENT_ScreenHeight + *D2Vars.D2CLIENT_UIPanelDrawYOffset - 200, COL_WHITE, 0, 5, L"DR%%");
	ExScreen::DrawTextEx(97 + *D2Vars.D2CLIENT_UIPanelDrawXOffset, *D2Vars.D2CLIENT_ScreenHeight + *D2Vars.D2CLIENT_UIPanelDrawYOffset - 270, COL_WHITE, 0, 5, L"Block%%");
	...
	int nREP = D2Funcs.D2COMMON_GetStatSigned(ptUnit, STAT_HPREGEN, 0);
	int nDRP = D2Funcs.D2COMMON_GetStatSigned(ptUnit, STAT_DAMAGERESIST, 0);

	int block = D2Funcs.D2COMMON_GetStatSigned(ptUnit, STAT_TOBLOCK, 0) + (ptUnit->dwClassId == 3 ? 30 : ptUnit->dwClassId == 0 || ptUnit->dwClassId == 4 || ptUnit->dwClassId == 6 ? 25 : 20);
	int totalblock = (block * (D2Funcs.D2COMMON_GetStatSigned(ptUnit, STAT_DEXTERITY, 0) - 15)) / (D2Funcs.D2COMMON_GetStatSigned(ptUnit, STAT_LEVEL, 0) * 2);
	int nBLK = totalblock > 75 ? 75 : totalblock;
	...
	nLen = ExScreen::GetTextWidth(wTxt.str().c_str());
	xPos = 97 - (nLen / 2) + *D2Vars.D2CLIENT_UIPanelDrawXOffset;
	D2Funcs.D2WIN_DrawText(wTxt.str().c_str(), xPos, *D2Vars.D2CLIENT_ScreenHeight + *D2Vars.D2CLIENT_UIPanelDrawYOffset - 156, COL_DARK_GOLD, 0);
	wTxt.str(L"");

	wTxt << nDRP;
	nLen = ExScreen::GetTextWidth(wTxt.str().c_str());
	xPos = 97 - (nLen / 2) + *D2Vars.D2CLIENT_UIPanelDrawXOffset;
	D2Funcs.D2WIN_DrawText(wTxt.str().c_str(), xPos, *D2Vars.D2CLIENT_ScreenHeight + *D2Vars.D2CLIENT_UIPanelDrawYOffset - 200, COL_DARK_GOLD, 0);
	wTxt.str(L"");

	wTxt << nBLK;
	nLen = ExScreen::GetTextWidth(wTxt.str().c_str());
	xPos = 147 - (nLen / 2) + *D2Vars.D2CLIENT_UIPanelDrawXOffset;
	D2Funcs.D2WIN_DrawText(wTxt.str().c_str(), xPos, *D2Vars.D2CLIENT_ScreenHeight + *D2Vars.D2CLIENT_UIPanelDrawYOffset - 270, COL_DARK_GOLD, 0);
	wTxt.str(L"");
