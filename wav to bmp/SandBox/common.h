...
std::vector<std::pair<int, int>> get_factors(int num);
void get_smallest_diff_xy(std::vector<std::pair<int, int>> list, int *x, int *y);
...
void GetFilesInDirectory(std::vector<std::string> &out, const std::string &directory, const std::string &filetype);
