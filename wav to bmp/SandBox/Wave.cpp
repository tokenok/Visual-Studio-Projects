...
BOOL CWave::Load(LPSTR lpszFilePath) {
	BOOL bResult = FALSE;
...
BOOL CWave::Save(LPSTR lpszFilePath) {
	BOOL bResult = FALSE;

	// Save .WAV file
	FILE* file;
	fopen_s(&file, lpszFilePath, "wb");
	if (file != NULL) {
		// Save .WAV descriptor
...
void CWave::print_info() {
	cout << hex << m_Descriptor.riff << '\n';
	cout << m_Descriptor.size << '\n';
	cout << m_Descriptor.wave << '\n';
	cout << '\n';
	cout << m_Format.id << '\n';
	cout << m_Format.size << '\n';
	cout << m_Format.format << '\n';
	cout << m_Format.channels << '\n';
	cout << m_Format.sampleRate << '\n';
	cout << m_Format.byteRate << '\n';
	cout << m_Format.blockAlign << '\n';
	cout << m_Format.bitsPerSample << '\n';
	cout << dec << '\n';
}
