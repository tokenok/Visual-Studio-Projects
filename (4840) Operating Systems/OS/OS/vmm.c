...
//
///*
//* adds a page to the page table. determines which page to replace if necessary
//* IN - page number to add
//* RETURN - page frame (index) of the added page
//*/
//int add_to_page_table(ushort page_n) {
//	//find unused page table entry
//	for (int i = 0; i < PAGE_FRAMES; i++) {
//		if (!PT[i].loaded) {//page hasn't been loaded yet
//			PT[i].page_n = page_n;
//			PT[i].loaded = 1;
//			return i;//return the index (page frame)
//		}
//	}
//
//	//TODO handle page table entry replacment (FIFO LRU etc)
//	return -1;
//}
//
//
...
//	//check page table
//	for (int i = 0; i < PAGE_FRAMES; i++) {
//		if (PT[i].loaded && PT[i].page_n == page_n) {
//			return i;//page hit
//		}
//	}
//
